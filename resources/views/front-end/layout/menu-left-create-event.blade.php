...
<div class="side-left">
    <div class="toolbar">
        <ul class="list">
            ...
            <li class="list-group" ><a href="{{route('buyHistory')}}"><h4 style ="font-size: 18px;">Vé đã mua</h4></a></li>
            <li class="list-group"><a href="{{route('eventList')}}"><h4 style ="font-size: 18px;">Các sự kiện</h4></a></li>
        </ul>
    </div>
</div>
