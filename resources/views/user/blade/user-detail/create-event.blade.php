                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane show" id="tab-eg1-1" role="tabpanel">
                        <div class="col-md-12">
                            <div class="main-card mb-3 card">
                                <div class="card-body ">
                                    <h5 class="card-title ">2. Thời gian sự kiện</h5>
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="position-relative form-group"><label  class="">Từ</label><input name="time-start"  type="time" class="form-control"></div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="position-relative form-group"><label  class="">Ngày</label><input name="date-start"   type="date" class="form-control"></div>
                                        </div>                            
                                    </div>
                                    <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="position-relative form-group"><label for="examplePassword11" class="">Đến</label><input name="password"   type="time" class="form-control"></div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="position-relative form-group"><label for="exampleEmail11" class="">Ngày</label><input name="email"   type="date" class="form-control"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane active show" id="tab-eg1-2" role="tabpanel">
                        <div class="col-md-12">
                            <div class="main-card mb-3 card">
                                <div class="card-body">
                                    <div class="title">
                                    ...
                                    <div  id="tickets-container">
                                        <div class="card-shadow-primary border mb-3 card card-body border-primary ticket-body">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="position-relative form-group col-md-12"><label for="exampleText" class="">Mô tả vé</label><textarea name="text"  class="form-control" placeholder="Sử dụng <br> để xuống dòng"></textarea></div>
                                                </div>                           
                                            </div>
                                        </div>
                                    </div>   
...
<!-- <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
        ...
        <div class=" col-md-12">
           <input type="submit" class="mb-2 mr-2 btn btn-primary btn-lg btn-block" value="Tạo sự kiện ">
        </div>
    </div>
</div> -->